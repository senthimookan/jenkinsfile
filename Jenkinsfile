  ...
  stage ("build")
   {
    ...
    {
        echo "copy file"
 bat 'copy  "C:/Program Files/Jenkins/workspace/mavendemo1/gameoflife-web/target/gameoflife.war" "C:/Program Files/Apache Software Foundation/Tomcat 9.0_Tomcat9a/webapps"'
